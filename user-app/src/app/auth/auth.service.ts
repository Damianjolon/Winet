...
export class AuthService {
  private apiUrl = `${environment.apiUrl}/auth`; // http://localhost:3001/api/auth
  ...
  changePassword(data: { usuario: string; oldPassword: string; newPassword: string }) {
    return this.http.post<any>(`${this.apiUrl}/change-password`, data);
  }

  // (opcional) helpers de sesión si los usas
